  ...
  const mainServices = [
    {
      ...
      description: "Comprehensive overhauling services for all types and makes of turbines and generators",
      features: [
      ...
      brands: ["BHEL", "Siemens", "LMZ", "GE", "Toshiba", "Dongfong", "Shanghai Electric", "Harbin"]
    },
    {
      icon: <TrendingUp className="w-12 h-12" />,
      title: "Renovation & Modernization",
      description: "Extend life and improve efficiency of aging power plant equipment",
      features: [
    ...
    },
    {
      ...
      description: "Comprehensive Annual Maintenance Contracts for worry-free operations",
      features: [
  ...
  const specialServices = [
    {
      ...
      description: "Turnkey solutions for complex power plant projects including erection, commissioning, and overseas assignments"
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Emergency Services",
      description: "Rapid mobilization for emergency breakdown situations with 24x7 availability"
    },
    {
      icon: <Clock className="w-8 h-8" />,
      title: "Shutdown Management",
      description: "Efficient planned shutdown execution with minimal downtime and maximum quality"
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Quality Assurance",
      description: "ISO certified processes ensuring highest quality standards in all our services"
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="space-y-8">
            {mainServices.map((service, index) => (
              <Card key={index} className="overflow-hidden hover:shadow-xl transition-all border-l-4 border-l-accent">
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
                    <div className="lg:col-span-1 bg-gradient-to-br from-primary/5 to-secondary/5 p-8 flex flex-col">
                    ...
                    <div className="lg:col-span-2 p-8 bg-card">
                      ...
                      {service.brands && (
                        <div className="mt-6 pt-6 border-t">
                          <h3 className="font-semibold mb-4 text-sm text-accent">Multi-Brand Expertise:</h3>
                          <div className="flex flex-wrap gap-2">
                            {service.brands.map((brand, bIndex) => (
                              <span key={bIndex} className="px-4 py-1.5 bg-accent/10 text-accent text-xs font-medium rounded-full hover:bg-accent/20 transition-colors">
                                {brand}
                              </span>
                            ))}
                          </div>
